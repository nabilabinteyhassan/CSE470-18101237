...
?>
	<table class="table">
		...
		<tr>
			...
			<td><?php echo "taka " . $book['book_price']; ?></td>
			<td><?php echo $qty; ?></td>
			<td><?php echo "taka " . $qty * $book['book_price']; ?></td>
		</tr>
		<?php } ?>
		<tr>
			<th>&nbsp;</th>
			...
			<th><?php echo "taka " . $_SESSION['total_price']; ?></th>
		</tr>
		<tr>
			<td>Shipping</td>
			<td>&nbsp;</td>
		...
		<tr>
			...
			<th>&nbsp;</th>
			<th>&nbsp;</th>
			<th><?php echo "taka " . ($_SESSION['total_price'] + 60); ?></th>
		</tr>
	</table>
	<form method="post" action="process.php" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
              	<input type="text" class="form-control" placeholder="Bkash number/PID/Contact number" name="card_number">
            </div>
        </div>
        <div class="form-group">
